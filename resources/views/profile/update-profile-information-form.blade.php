<x-jet-form-section submit="updateProfileInformation">
    <x-slot name="title">
       <span style="color: black"> {{ __('Información del perfil') }}</span>
    </x-slot>

    <x-slot name="description">
        <span style="color: black">  {{ __('Actualice la información de perfil y la dirección de correo electrónico de su cuenta.') }}</span>
