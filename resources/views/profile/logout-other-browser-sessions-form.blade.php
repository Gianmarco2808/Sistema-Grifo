<x-jet-action-section>
    <x-slot name="title">
        <span style="color: rgb(0, 0, 0);">{{ __('Sesiones del navegador') }}</span>
    </x-slot>

    <x-slot name="description">
        <span style="color: rgb(0, 0, 0);"> {{ __('Administre y cierre la sesión de sus sesiones activas en otros navegadores y dispositivos.') }}</span>
    </x-slot>
